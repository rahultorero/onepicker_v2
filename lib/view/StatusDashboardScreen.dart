                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                PieChart(
                                  PieChartData(
                                    sections: _buildEnhancedPieSections(pendingData),
                                    sectionsSpace: 2,
                        ...
                        Expanded(
                          flex: 2,
                          child: _buildEnhancedPieChartLegend(pendingData),
                        ),
                      ],
                    ),
                  ),
...
// Enhanced pie sections
  List<PieChartSectionData> _buildEnhancedPieSections(List<DataItem> pendingData) {
    final total = pendingData.fold<double>(0, (sum, item) => sum + item.pend!);

    return pendingData.asMap().entries.map((entry) {
      final index = entry.key;
      final statusData = entry.value;
      final color = AppTheme.chartColors[index % AppTheme.chartColors.length];
      ...
      return PieChartSectionData(
        ...
        title: percentage > 5 ? '${percentage.toStringAsFixed(1)}%' : '', // Hide small percentages
        radius: 60, // Reduced from 85
...
// Enhanced legend with better layout
  Widget _buildEnhancedPieChartLegend(List<DataItem> pendingData) {
    final total = pendingData.fold<double>(0, (sum, item) => sum + item.pend!);
